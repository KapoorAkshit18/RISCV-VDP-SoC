...
HD_PWD='C:/projects/vga_ps/vga_ps.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cb_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cb_wrapper.tcl -notrace
