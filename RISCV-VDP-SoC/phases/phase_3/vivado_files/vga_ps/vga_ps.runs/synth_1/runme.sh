...
HD_PWD='C:/projects/vga_ps/vga_ps.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cb_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cb_wrapper.tcl
